...
import Mail from '../assets/Frame.png'
...
function Navbar() {
  return (
    <div className=" font-['Mulish']">
     ...
     <div className="w-full bg-[#F2F2F2] mx-auto">
     <div className="w-[88%] rounded h-[69px] p-[21px] mx-auto bg-[#1C2752] text-[#FFB342]  md:flex md:justify-between ">
      <div>
       <p>Рабочие часы:  <span className='font-[600]'> 06:00 to 20:00 </span></p>
      </div>
      <div>
     ...
     <div className="w-full  h-[180px]">
        <div className="w-[88%]  h-[128px] p-[21px] mx-auto  md:flex md:justify-between">
             <div className='md:flex md:justify-between items-center'>
              <img src={Logo} alt="" className='w-full rounded-2xl'  />
             </div>
             <div className='w-[30%] md:flex md:justify-between'>
               <p className='w-[42%] md:flex md:justify-between items-center'><img src={Mail} alt="" className='w-[48px] h-[48px] '/><span className='font-[600]'> Написать на почту</span> </p>
               <p className='w-[30%] md:flex md:justify-between items-center'><img src={Phone} alt="" className='w-[48px] h-[48px]'/> <span className='font-[600]'> Позвонить </span></p>
             </div>
        </div>
        
        <div className="w-[100%] h-[88px] mx-auto bg-white rounded-[2px] relative z-50 shadowLg ">
         <div className='mx-auto w-[88%] md:flex md:justify-between'>
          <div className='w-[80%] md:flex md:justify-between p-6 text-[22px] font-[600] text-[#1C2752]'>
            ...
            <Link to={`/документы`} className='w-[15%] h-[40px] flex justify-center items-center hover:font-[500] hover:text-[20px] hover:text-white  hover:bg-[#1C2752] hover:border-blue-500    focus:font-[500] focus:text-[20px] focus:text-white  focus:bg-[#FFB342] focus:border-blue-500 rounded-[4px]' >  Документы</Link>
              <a href="" className='w-[15%] h-[40px] flex justify-center items-center hover:font-[500] hover:text-[20px] hover:text-white  hover:bg-[#1C2752] hover:border-blue-500 rounded-[4px]'>О предприятии</a>
              <a href="" className='w-[15%] h-[40px] flex justify-center items-center hover:font-[500] hover:text-[20px] hover:text-white  hover:bg-[#1C2752] hover:border-blue-500 rounded-[4px]'>Контакты</a>

          </div>
          <div>
          <button className='mt-2 w-[298px] h-[68px] bg-[#1C2752]  text-[#F4F4F4]  rounded-[8px] hover:shadow-xl hover:w-[310px] hover:bg-[#FFB342] hover:text-black hover:transition-[200px] ' type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">Есть Вопросы?</button>
